...
from core.domain.entities import Produto, Cliente, Fatura, ItemFatura
from core.application.repositories import IProdutoRepository, IClienteRepository, IFaturaRepository
